...
<section class="featured spad">
    <div class="container">
        ...
        <div class="row featured__filter">
            <?php
            require './db/conn.php';
            $sql_str = "SELECT products.id as pid, products.name as pname, price, images, categories.slug as cslug FROM products, categories WHERE products.category_id = categories.id;";
            $result = mysqli_query($conn, $sql_str);
            while ($row = mysqli_fetch_assoc($result)) {
                $images_arr = explode(';', $row['images']);
                ?>

                <div class="col-lg-3 col-md-4 col-sm-6 mix <?= $row['cslug']; ?> fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="./admin/<?= $images_arr[0]; ?>">
